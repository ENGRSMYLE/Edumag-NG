      ...
      <div className="card-shell">
        <div className="card-core p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-semibold text-[var(--color-text-primary)] font-display">Record Timeline</h3>
          </div>
          <div className="flex flex-wrap gap-6">
            <div>
              <span className="text-[11px] font-semibold uppercase tracking-[0.1em] text-[var(--color-text-muted)]">Created</span>
              <p className="text-sm text-[var(--color-text-primary)] font-mono tabular-nums mt-0.5">{formatDate(student.created_at)}</p>
            </div>
            <div>
              <span className="text-[11px] font-semibold uppercase tracking-[0.1em] text-[var(--color-text-muted)]">Last Updated</span>
              <p className="text-sm text-[var(--color-text-primary)] font-mono tabular-nums mt-0.5">{formatDate(student.updated_at)}</p>
            </div>
          </div>
        </div>
      </div>
