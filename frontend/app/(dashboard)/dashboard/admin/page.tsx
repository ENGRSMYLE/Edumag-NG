...
const EnrollmentChart = dynamic(
  () => import('@/app/(dashboard)/dashboard/super-admin/_components/EnrollmentChart'),
  { ssr: false, loading: () => <div className="skeleton h-[200px] rounded-lg" /> },
);
const RevenueChart = dynamic(
  () => import('@/app/(dashboard)/dashboard/super-admin/_components/RevenueChart'),
  { ssr: false, loading: () => <div className="skeleton h-[200px] rounded-lg" /> },
);
        ...
        <div className="card-core">
          ...
          <div className="divide-y divide-[var(--color-border)]">
            {isLoading ? (
              ...
              activities.slice(0, 10).map((item) => <ActivityRow key={item.id} item={item} />)
            )}
          </div>
        </div>
      </div>
