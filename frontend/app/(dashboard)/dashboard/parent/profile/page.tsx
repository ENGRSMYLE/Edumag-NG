...
export default function ProfilePage() {
  ...
  return <div><PageHeader title="My Profile" description="Manage your contact preferences. Contact the school to change your identity information." />
    {query.isError ? <p className="text-red-600">Profile could not be loaded.</p> : <form onSubmit={submit} className="card-shell max-w-2xl"><div className="card-core space-y-4 p-5">
