...
const NAV_SECTIONS: NavSection[] = [
  {
    label: 'OVERVIEW',
    items: [
      { href: '/dashboard/super-admin', icon: LayoutDashboard, label: 'Dashboard', exact: true },
    ],
  },
  {
    label: 'MANAGEMENT',
    items: [
      { href: '/dashboard/super-admin/students', icon: Users, label: 'Students' },
      { href: '/dashboard/super-admin/staff', icon: UserCheck, label: 'Staff & Admins' },
    ],
  },
  {
    label: 'ACADEMICS',
    items: [
      { href: '/dashboard/super-admin/classes', icon: BookOpen, label: 'Classes' },
    ],
  },
  {
    label: 'FINANCE',
    items: [
      { href: '/dashboard/super-admin/finance', icon: CreditCard, label: 'Payments' },
    ],
  },
  {
    label: 'COMMUNICATION',
    items: [
      { href: '/dashboard/super-admin/announcements', icon: Megaphone, label: 'Announcements' },
    ],
  },
  {
    label: 'SYSTEM',
    items: [
      { href: '/dashboard/super-admin/settings', icon: Settings, label: 'Settings', exact: true },
      { href: '/dashboard/super-admin/settings/logs', icon: ScrollText, label: 'System Logs', exact: true },
    ],
  },
];
        ...
        {collapsed ? (
          <div className="flex flex-col items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-[var(--color-gold)] flex items-center justify-center">
              <span className="text-[11px] font-bold text-[var(--color-navy)] leading-none">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <span className="inline-block mt-1 px-1.5 py-0.5 rounded text-[10px] font-medium bg-[var(--color-gold)]/15 text-[var(--color-gold)] leading-none">
                Super Admin
              </span>
            </div>
            <button
