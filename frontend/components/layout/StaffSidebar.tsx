...
const NAV_SECTIONS: NavSection[] = [
  {
    label: 'OVERVIEW',
    items: [
      { href: '/dashboard/staff', icon: LayoutDashboard, label: 'My Dashboard', exact: true },
    ],
  },
  {
    label: 'MY CLASS',
    items: [
      { href: '/dashboard/staff/my-class', icon: Users, label: 'My Students' },
    ],
  },
  {
    label: 'ATTENDANCE',
    items: [
      { href: '/dashboard/staff/attendance', icon: ClipboardCheck, label: 'Take Attendance' },
    ],
  },
  {
    label: 'ACADEMICS',
    items: [
      { href: '/dashboard/staff/scores', icon: BookOpen, label: 'Scores' },
      { href: '/dashboard/staff/assignments', icon: ClipboardList, label: 'Assignments' },
    ],
  },
  {
    label: 'COMMUNICATION',
...
export function StaffSidebar({ collapsed, onToggle, onClose }: StaffSidebarProps) {
        ...
        {collapsed ? (
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <span className="inline-block mt-1 px-1.5 py-0.5 rounded text-[10px] font-medium bg-emerald-500/15 text-emerald-400 leading-none">
                Teacher
              </span>
            </div>
            <button
